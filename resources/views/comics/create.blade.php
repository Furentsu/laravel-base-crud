    ...
    <form action="">
        <div class="row d-flex justify-content-center mt-5">
            <div class="col-5">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label">Japanese Title</label>
                    <input type="text" name="name" id="name" class="form-control" >
                </div>
        
                <div class="mb-3">
                    <label for="japanese_title" class="form-label">Author</label>
                    <input type="text" name="japanese_title" id="japanese_title" class="form-control" >
                </div>
